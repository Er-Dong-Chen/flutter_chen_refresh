...
class _ReorderableListContentState extends State<_ReorderableListContent>
  ...
  Widget _wrap(Widget toWrap, int index, BoxConstraints constraints) {
    ...
    return Builder(builder: (BuildContext context) {
      return DragTarget<Key>(
        builder: (BuildContext context, List<Key> acceptedCandidates,
        ...
        onWillAcceptWithDetails: (DragTargetDetails<Key> details) {
          ...
          return _dragging == details.data && details.data != toWrap.key;
        },
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      ...
      final Key endWidgetKey = Key('DraggableList - End Widget');
