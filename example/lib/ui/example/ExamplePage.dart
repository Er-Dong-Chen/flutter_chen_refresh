...
import 'package:example/ui/example/useStage/nested_scroll.dart';
...
class ExampleItem extends StatefulWidget {
  ...
  ExampleItem({required this.title, this.onClick});
}
            ...
            Navigator.of(context).push(MaterialPageRoute(builder: (context) {
              return Scaffold(
                body: AnimatedListExample(
                  listKey: GlobalKey(),
                  removedItemBuilder: (item, context, animation) => SizedBox(),
                ),
                appBar: AppBar(),
              );
            }));
